...
const services = [
  { icon: Cog, title: "CNC Turning & Milling", img: cncTurning, desc: "State-of-the-art CNC machines capable of producing complex geometries with high precision and repeatability.", items: ["Multi-Axis CNC Turning", "3-Axis to 5-Axis Milling", "Swiss-Type CNC Lathes", "Turn-Mill Combined Centers"] },
  { icon: Target, title: "Precision Machining", img: cncMilling, desc: "Manufacturing high-accuracy components for industries requiring tight tolerances and superior surface finish quality.", items: ["Tight Tolerance Machining", "Superior Surface Finish", "Complex Geometry", "Exotic Material Machining"] },
  { icon: Wrench, title: "Grinding & Finishing", img: qualityLab, desc: "Comprehensive grinding operations for achieving the highest levels of dimensional accuracy and surface quality.", items: ["Cylindrical Grinding", "Surface Grinding", "Internal Grinding", "Deburring & Polishing"] },
  { icon: Layers, title: "Prototype & Production", img: facilityImg, desc: "From prototype development to high-volume batch production with consistent quality standards.", items: ["Prototype Components", "Low Volume Production", "Medium Batch Production", "High Volume Manufacturing"] },
];
...
const technicalStrengths = [
  "4-Axis & 5-Axis Machining", "Reverse Engineering", "Import Substitution Development",
  "Engineering Collaboration", "Complex Geometry Machining", "Jig & Fixture Manufacturing",
];
    ...
    <section className="relative pt-36 pb-24 bg-gradient-dark overflow-hidden">
      ...
      <div className="container relative">
        <motion.div initial="hidden" animate="visible" variants={fadeUp}>
          ...
          <p className="mt-4 text-steel max-w-xl text-lg">Comprehensive precision machining solutions from prototype development to high-volume production.</p>
        </motion.div>
      </div>
    </section>
